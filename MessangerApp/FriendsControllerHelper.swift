...
extension FriendsController {
    ...
    func setupData() {
        ...
        if let context = delegate?.managedObjectContext {
            ...
            createMessageWithText("Are you interested in buying an Apple device? We have a wide varety of Apple devices that will suit your needs. Please make your purchase with us.", friend: steve, minutesAgo: 1, context: context)
